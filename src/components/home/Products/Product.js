...
const Product = ({ productName, img, price, discountedPrice, badge, isMobile }) => {
    ...
    >
      ...
      <div
        className={`absolute inset-0 ${
          isMobile
            ? "backdrop-blur-[2px] backdrop-saturate-150 bg-white/40"
            : "backdrop-blur-sm backdrop-saturate-180 bg-white/30"
        } border border-white/30 rounded-lg z-0`}
      ></div>
