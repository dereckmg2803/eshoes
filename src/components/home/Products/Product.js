...
>
  {/* Contenedor de fondo separado */}
  <div className="absolute inset-0 backdrop-blur-sm backdrop-saturate-180 bg-white/30 border border-white/30 rounded-lg z-0 pointer-events-none"></div>

  {/* Contenido sin desenfoque */}
  <div className="relative z-10 bg-white bg-opacity-80 p-2 rounded-lg">
    <div className="max-w-80 max-h-80 relative overflow-hidden h-48">
      <Image
